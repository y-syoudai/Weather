...
public class WeatherDao {
	...
	private static final String SQL_SELECT_CITY = "select * from weather where cityId = ?";
	private static final String SQL_SELECT_CITY_LIST = "select * from weather";
	private static final String SQL_DELETE_CITY = "delete from weather where cityId = ?";
	...
	public WeatherBean selectCity(String cityId) throws SQLException {
	...
	public List<WeatherBean> selectCityList() throws SQLException {
		PreparedStatement ps = this.connection.prepareStatement(SQL_SELECT_CITY_LIST);
		ResultSet rs = ps.executeQuery();
	...
	public int insertCity(WeatherBean weatherBean) throws SQLException {
